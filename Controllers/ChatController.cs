...
namespace Satizen_Api.Controllers
{
    ...
    public class MensajesController : ControllerBase
    {
        ...
        // GET: api/Mensajes/ParaReceptor/{receptorId}
        [HttpGet("ParaReceptor/{receptorId}")]
        public async Task<ActionResult<IEnumerable<Mensaje>>> GetMensajesParaReceptor(int receptorId)
        {
            var mensajes = await _context.Mensajes
                .Where(m => m.idReceptor == receptorId)
        ...
        public async Task<ActionResult<Mensaje>> PostMensaje(CreateMensajeDto CreateMensajeDto)
        {
            ...
            await _hubContext.Clients.Group(groupName).SendAsync("ReceiveMessage", nuevoMensaje.idAutor, nuevoMensaje.idReceptor, nuevoMensaje.contenidoMensaje, nuevoMensaje.Timestamp);
